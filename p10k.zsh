# Generated by Powerlevel10k configuration wizard on 2024-02-29 at 14:18 EST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # If local branch name is at most 32 characters long, show it in fu.
  ...
  typeset -g POWERLEVEL9K_VCS_LOADING_VISUAL_IDENTIFIER_COLOR=14
  # Custom icon.
